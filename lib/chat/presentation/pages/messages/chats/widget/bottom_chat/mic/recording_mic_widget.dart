...
import 'package:university/chat/presentation/pages/messages/chats/widget/bottom_chat/mic/custom_timer_count_up.dart';
...
class _RecordingMicWidgetState extends State<RecordingMicWidget>
  ...
  double micHorizontal = 0;
  double micVertical = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
          vertical: mq.height * .013, horizontal: mq.width * .022),
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                width: micWidth,
                height: micHeight,
                child: Icon(isVerticalActionComplete ? Icons.send : Icons.mic,
