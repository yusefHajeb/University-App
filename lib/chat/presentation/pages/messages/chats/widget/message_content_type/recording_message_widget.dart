...
class RecordingMessageWidget extends StatefulWidget {
  final TextMessageEntity messageData;
  final bool isSender;

  const RecordingMessageWidget(
      {Key? key, required this.messageData, required this.isSender})
      : super(key: key);

  @override
  State<RecordingMessageWidget> createState() => _RecordingMessageWidgetState();
}

class _RecordingMessageWidgetState extends State<RecordingMessageWidget> {
      ...
      children: [
        Container(
          ...
          child: ClipRRect(
            ...
            child: Image.network(
                "${Constants.linkImageRootImage}/${widget.messageData.senderProfile}",
                fit: BoxFit.fill),
          ),
        ),
        Positioned(
